...
22. 如果有.git目录，使用**git-dumper**`git-dumper http://dev.linkvortex.htb/.git website/`下载，在website目录下使用`git log`查看历史，在使用`git show commit(数字)`进行查看信息 
